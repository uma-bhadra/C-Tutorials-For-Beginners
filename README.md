...
- Implementing linked lists using struct and malloc (memory allocation)
...
- While loops
- Queues and Stacks
- Capitilizing the first letter of a name
- Flipping capital letters to lowercase and vice versa in a string 
- Implementing the add instruction manually
